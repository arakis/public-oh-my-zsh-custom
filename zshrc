...
# ZSH_THEME="minimal"
ZSH_THEME="mytheme" # basiert auf "minimal"
...
# emac keybinding, for example ctrl+left/right word navigation
bindkey -e
...
ZSH_HIGHLIGHT_PATTERNS+=('rm -rf *' 'fg=white,bold,bg=red') # funktioniert nicht
...
# safe ops (for example, "overwrite? yes/no")
